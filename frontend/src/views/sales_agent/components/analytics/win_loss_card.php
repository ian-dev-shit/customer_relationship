...
<div class="bg-white p-5 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col justify-between w-full h-auto">
  <div>
    ...
    <div class="flex items-center justify-between mb-2">
      <div>
        <h3 class="text-sm font-bold text-slate-800 tracking-tight">Win / Loss by Service Type</h3>
        <p class="text-[11px] text-slate-400">Deal conversion breakdown across logistics services</p>
      </div>
    ...
    <div class="w-full min-w-0">
      <div id="winLossStackedBarChart" class="w-full min-h-[180px]"></div>
    </div>
  </div>
  ...
  <div class="mt-2 p-3.5 rounded-2xl bg-slate-50 border border-slate-100 flex items-start gap-3">
    ...
    <div>
      <h4 class="text-[11px] font-bold text-slate-800 uppercase tracking-wider">AI Strategy Recommendation</h4>
      <p id="ai-win-loss-suggestion" class="text-xs text-slate-600 mt-0.5 leading-relaxed">
        Analyzing deal conversion patterns across services...
      </p>
    </div>
  </div>
</div>